...
namespace SmartaceEDMSAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<EDMSAuditAppContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultAudit")));
            ...
            {
                config.UseSqlServerStorage(Configuration.GetConnectionString("DefaultAudit"));
            });
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Version = _apiVersion,
                    Title = "Smartace EDMS Audit API",
                    Description = "EDMS Audit",
        ...
        private void RegisterServices(IServiceCollection services)
        {
            ...
            services.AddTransient<DbContext, SmartaceEDMS.API.Data.EDMSAuditAppContext>();
            services.AddTransient(typeof(SmartaceEDMS.API.Data.EDMSAuditAppContext));
            services.AddTransient(typeof(DbContextOptions<SmartaceEDMS.API.Data.EDMSAuditAppContext>));
